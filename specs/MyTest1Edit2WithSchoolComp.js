// Positive user tests are written individually first for beginner readability.
// Negative login tests are included at the bottom of this file.
...
describe('Positive Login Tests - standard_user', () => {

   it('should login with valid credentials using standard_user and visit Sauce Labs', async () => {
       ...
       await browser.pause(1000); // short pause so About page can finish loading

       // Sauce Labs page hangs on this machine, so re-login directly and continue test flow
       await browser.reloadSession();
       await theLoginPage.open();
       await theLoginPage.login('standard_user', 'secret_sauce');
       await browser.waitUntil(
           async () => (await browser.getUrl()).includes('inventory.html'),
           { timeout: 10000, timeoutMsg: 'Failed to return to inventory after re-login' }
       );
...
describe('Positive Login Tests - problem_user', () => {

   it('should login with valid credentials using problem_user and visit Sauce Labs', async () => {
    await browser.reloadSession();
...
describe('Positive Login Tests - performance_glitch_user', () => {

   it('should login with valid credentials using performance_glitch_user and visit Sauce Labs', async () => {
       await browser.reloadSession();
       await browser.url('https://www.saucedemo.com/');
        // Login
       await theLoginPage.open();
...
describe('Positive Login Tests - error_user', () => {

   it('should login with valid credentials using error_user and visit Sauce Labs', async () => {
       await browser.reloadSession();
       await browser.url('https://www.saucedemo.com/');
...
describe('Positive Login Tests - visual_user', () => {

   it('should login with valid credentials using visual_user and visit Sauce Labs', async () => {
       await browser.reloadSession();
       await browser.url('https://www.saucedemo.com/');
